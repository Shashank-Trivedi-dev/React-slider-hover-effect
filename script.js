const slideData = [
{
  ...
  button: 'Shop now',
  src: 'https://shashanktrivedi.com/wp-content/uploads/2023/09/fashion.jpg' },

{
  index: 1,
  headline: 'In The Wilderness',
  button: 'Book travel',
  src: 'https://shashanktrivedi.com/wp-content/uploads/2023/09/forest.jpg' },

{
  index: 2,
  headline: 'For Your Current Mood',
  button: 'Listen',
  src: 'https://shashanktrivedi.com/wp-content/uploads/2023/09/guitar.jpg' },

{
  index: 3,
  headline: 'Focus On The Writing',
  button: 'Get Focused',
  src: 'https://shashanktrivedi.com/wp-content/uploads/2023/09/typewriter.jpg' }];
